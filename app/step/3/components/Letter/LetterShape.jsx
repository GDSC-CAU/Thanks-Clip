...
const LetterTorn = ({ children, colorType }) => {
    return (
        <div
            style={{
...
const LetterOverlap = ({ children, colorType }) => {
    return (
        <div
            className={colorType}
            style={{
...
const LetterHole = ({ children, colorType }) => {
    return (
        <div
            className={colorType}
            style={{
...
const LetterShape = ({ children }) => {
    ...
    const color = colorList[letter.backgroundColor]
    return (
        <>
            {type === "torn" && (
                <LetterTorn {...letter} colorType={color}>
                    {children}
                </LetterTorn>
            )}
