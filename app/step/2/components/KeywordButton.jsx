const keywordBtn =
    "h-12 py-1.5 text-md border-solid border-2 rounded-full bg-gray-300 text-gray-500 border-gray-300"
...
const KeywordButton = ({ children, id, isSelected, onClick }) => {
    ...
    return (
        <button
            className={`w-full text-sm hover:scale-[101%] active:scale-95 transition ${keywordBtnStyle}`}
            onClick={() => onClick(id)}
        >
            {children}
        </button>
